...
**把读书笔记、人物资料和商业事件做成可搜索知识库**

- 适合微信读书笔记、企业家人物志、学习资料门户和知识卡片库。
- 总览、时间轴、关系、地图、事件、统计、书库等视图已经打通。
- 只要维护 `data.js` / `books.js`，就能持续扩展内容。

## 30 秒改成你的项目

Fork 后替换 `data.js` 和 `books.js`，即可做自己的读书卡片库、人物库或行业资料库。
